			...
			<view>
				<view class="page-body">
					<view class="page-section page-section-gap">
						<map style="width: 100%; height: 200px;" :latitude="latitude" :longitude="longitude" scale="13"
							:markers="markers">
						</map>
					</view>
				</view>
		...
		<view class="infotop u-m-t-15">
			<view class="info-top-titles">
				...
				<u-row gutter="16" justify="around">
					...
					<u-col span="3">
						<view class="demo-layout ">
							<h3>温度:<span class='u-font-35'>{{'3℃'}}</span></h3>
						</view>
					</u-col>
					<u-col span="3">
						<view class="demo-layout ">
							<h3>湿度:<span class='u-font-35'>{{'2%'}}</span></h3>
						</view>
					</u-col>
				</u-row>
			...
			uni.getLocation({
					...
					success: (res) => {
						...
						this.markers = [{
							...
							//标记坐标位置
								{
									iconPath: '/static/biaoji9.png',
									id: 1,
									longitude: 103.683000,
									latitude: 30.912225
								},
								{
									iconPath: '/static/biaoji9.png',
									id: 1,
									longitude: 103.673000,
									latitude: 30.922225
								},
								{
									iconPath: '/static/biaoji9.png',
									id: 1,
									longitude: 103.663000,
									latitude: 30.912225
								},
								{
									iconPath: '/static/biaoji9.png',
